    ...
    <Container>
      ...
      <CompanyContactsContainer>
        <CompanyContactsInner>
          <CompanyContactsItem>
            <GlobeIcon />
            <ContactsItemText>{website}</ContactsItemText>
          </CompanyContactsItem>
          <CompanyContactsItem style={{ marginLeft: '25px' }}>
            <PhoneIcon />
            <ContactsItemText>{phone}</ContactsItemText>
          </CompanyContactsItem>
        </CompanyContactsInner>
      ...
      <LinkToCompany href={link} target="_blank">
        Go to the company's website
      </LinkToCompany>
      <Title style={{ marginTop: '60px' }}>Customer Demographics</Title>
      <DemographicsText>
        Consumer data is representative of this brand’s consumers that follow them on
        social media. The rankings and lists represent the highest indexing (or most above
        average) attributes and preferences of this dataset.
      </DemographicsText>
